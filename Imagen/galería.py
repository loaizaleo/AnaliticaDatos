# =============================================================================
# GENERADOR DE GALERÍA HTML POR GRUPOS DE SIMILITUD - CÓDIGO COMPLETO
# =============================================================================
...
def generate_html_gallery(results_df, image_dir, output_file='galeria_similitud.html'):
    """
    ...
    <body>
        <div class="header">
            ...
            <p>Agrupación automática basada en características visuales - Total: {total_images} imágenes</p>
        </div>
    ...
    for cluster_id in cluster_stats.index:
        ...
        html_content += f'<a href="#cluster-{cluster_id}" class="jump-item">Grupo {cluster_id} ({count} imágenes)</a>'
    ...
    # Reemplazar placeholders con estadísticas reales
    html_content = html_content.format(
        total_images=total_images,
        total_clusters=total_clusters,
        avg_per_cluster=avg_per_cluster,
        largest_cluster=largest_cluster,
        single_image_clusters=single_image_clusters
    )
...
def generate_comparison_html(results_df, image_dir, output_file='comparacion_grupos.html'):
    """
    ...
    <body>
        <div class="header">
            ...
            <p>Vista comparativa de todos los grupos - {total_clusters} grupos encontrados</p>
        </div>
    ...
    for cluster_id, group_data in grouped:
        ...
        for filename in cluster_images:
            ...
            try:
                ...
                html_content += f'<img src="data:image/jpeg;base64,{img_str}" class="comparison-img" title="{filename}">'
            except:
                html_content += f'<div style="width:80px;height:80px;background:#eee;display:flex;align-items:center;justify-content:center;border-radius:5px;font-size:10px;">Error</div>'
    ...
    html_content = html_content.format(total_clusters=len(grouped))
...
# =============================================================================
# EJECUCIÓN PRINCIPAL - CÓDIGO COMPLETO Y CORREGIDO
# =============================================================================
...
def main():
    ...
    try:
        # Generar galería principal - LÍNEA COMPLETA Y CORREGIDA
        galeria_file = generate_html_gallery(results_df, IMAGE_DIR, 'galeria_similitud_tenis.html')
        print(f"✅ Galería principal generada: {galeria_file}")
        
        # Generar página de comparación
        comparacion_file = generate_comparison_html(results_df, IMAGE_DIR, 'comparacion_grupos_tenis.html')
        print(f"✅ Página de comparación generada: {comparacion_file}")
        
        # Mostrar estadísticas
        cluster_stats = results_df['grupo_similitud'].value_counts()
        print(f"\n📊 Resumen de grupos:")
        print(f"   - Total de grupos: {len(cluster_stats)}")
        ...
        <div style="background: #e8f5e8; padding: 20px; border-radius: 10px; border-left: 5px solid #4caf50;">
            <h3>🎉 ¡Galerías HTML Generadas Exitosamente!</h3>
            ...
            <p style="margin-top: 15px; color: #555;">
                ...
                Usa la galería principal para explorar grupos individualmente y la página de comparación 
                para ver todos los grupos lado a lado.
            </p>
        </div>
        """))
        ...
        print("💡 Verifica que las imágenes estén en la ruta correcta")
